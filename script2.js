...
{
    document.getElementById("password2-error").innerHTML="Password length above 8 characters";
    password1.focus();
   ...
   if(password.value!=password1.value)
{
    ...
    if(password1.value.length==password1.value.length)
    {
...
if(message.value=="")
{
document.getElementById("message-error").innerHTML="*Encourage us..!";
message.focus();
message.style.borderBottom="solid red 3px";
return false;
}

document.getElementById("message-error").innerHTML='<i class="fa-solid fa-circle-check"></i>';
message.style.borderBottom="solid green 3px";
 return true;
}
